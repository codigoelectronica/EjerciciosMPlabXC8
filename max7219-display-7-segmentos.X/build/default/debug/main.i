...
void max7219_Config(void) {
    ...
    max7219_WriteComando(0x0C, 0x00);
    max7219_WriteComando(0x0F, 0x00);
    max7219_WriteComando(0x0A, 0x0F);
    max7219_WriteComando(0x0B, 0x07);
    max7219_WriteComando(0x0C, 0x01);
...
void max7219_Intensity(unsigned char value) {
    if (value < 16) {
        max7219_WriteComando(0x0A, value);
    }
}
